...
local library = {
    version = "1.0.0",
    title = title or "Nexus " .. tostring(math.random(1,366)),
    fps = 0,
    rank = "private"
}
...
function library:InitNotifications(text, duration, callback)
    ...
    function Notification:Notify(text, duration, type, callback)
        ...
        bar.Name = "bar"
        bar.Parent = barFolder
        bar.BackgroundColor3 = Color3.fromRGB(155, 155, 255)
...
function library:Introduction()
    ...
    local barCorner = Instance.new("UICorner")
    local barLayout = Instance.new("UIListLayout")
    local NexusLogo = Instance.new("ImageLabel")
    local hashLogo = Instance.new("ImageLabel")
    local Nexus = Instance.new("TextLabel")
    ...
    NexusLogo.Name = "NexusLogo"
    NexusLogo.Parent = background
    NexusLogo.AnchorPoint = Vector2.new(0.5, 0.5)
    NexusLogo.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
    NexusLogo.BackgroundTransparency = 1.000
    NexusLogo.Position = UDim2.new(0.5, 0, 0.5, 0)
    NexusLogo.Size = UDim2.new(0, 448, 0, 150)
    NexusLogo.Visible = true
    NexusLogo.Image = "http://www.roblox.com/asset/?id=9365068051"
    NexusLogo.ImageColor3 = Color3.fromRGB(155, 155, 255)
    NexusLogo.ImageTransparency = 1
    ...
    hashLogo.ImageColor3 = Color3.fromRGB(155, 155, 255)
    hashLogo.ImageTransparency = 1
    
    Nexus.Name = "Nexus"
    Nexus.Parent = background
    Nexus.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
    Nexus.BackgroundTransparency = 1.000
    Nexus.Size = UDim2.new(0, 80, 0, 21)
    Nexus.Font = Enum.Font.Code
    Nexus.Text = "powered by Nexus"
    Nexus.TextColor3 = Color3.fromRGB(124, 124, 124)
    Nexus.TextSize = 10.000
    Nexus.TextTransparency = 1
    ...
    CreateTween("NexusRotation", 0)
    local MinusAmount = -16
    coroutine.wrap(function()
        while wait() do
            MinusAmount = MinusAmount + 0.4
            TweenService:Create(NexusLogo, TweenTable["NexusRotation"], {Rotation = NexusLogo.Rotation - MinusAmount}):Play()
        end
    end)()
    ...
    wait(.2)
    TweenService:Create(Nexus, TweenTable["introduction"], {TextTransparency = 0}):Play()
    TweenService:Create(text, TweenTable["introduction"], {TextTransparency = 0}):Play()
    wait(.3)
    TweenService:Create(NexusLogo, TweenTable["introduction"], {ImageTransparency = 0}):Play()
    wait(2)
    TweenService:Create(NexusLogo, TweenTable["introduction"], {ImageTransparency = 1}):Play()
    wait(.2)
    ...
    wait(.1)
    TweenService:Create(Nexus, TweenTable["introduction"], {TextTransparency = 1}):Play()
    wait(.1)
